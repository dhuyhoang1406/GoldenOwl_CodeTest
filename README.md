...
PostgreSQL: `localhost:5432`, database `gscores`, user/password `postgres`.
...
npm run seed          # import dataset/diem_thi_thpt_2024.csv (~ vài phút)
npm run start:dev
```
...
| Endpoint | Mô tả |
|----------|--------|
| `GET /api/scores/lookup/:sbd` | Tra cứu điểm theo số báo danh |
| `GET /api/scores/report/distribution` | Báo cáo 4 mức điểm theo môn |
| `GET /api/scores/report/top-group-a` | Top 10 khối A (Toán, Lý, Hóa) |
